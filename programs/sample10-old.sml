...
(*Obsolete syntax, should be :> *)
abstraction Rule : RULE =
  struct
...
signature TACTICAL =
  ...
  val -- :   ('a,'b) multifun * ('b,'_c) multifun -> ('a,'_c) multifun
  val || : ('a,'b) multifun * ('a,'b) multifun -> ('a,'b) multifun
  val |@| : ('a,'_b) multifun * ('a,'_b) multifun -> ('a,'_b) multifun
  val all : ('_a,'_a) multifun
  val no :  ('a,'b) multifun
  val try :    ('_a,'_a) multifun -> ('_a,'_a) multifun
  val repeat : ('_a,'_a) multifun -> ('_a,'_a) multifun
  val repeatDeterm : ('_a,'_a) multifun -> ('_a,'_a) multifun
  val depthFirst : ('_a -> bool) -> ('_a,'_a) multifun -> ('_a,'_a) multifun
  val depthIter : ('_a -> bool) * int -> ('_a,'_a) multifun -> ('_a,'_a) multifun
