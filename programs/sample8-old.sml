...
signature IMP_SEQUENCE = 
  ...
  val fromList: '_a list -> '_a t
  val @ : '_a t * '_a t -> '_a t
  val interleave : '_a t * '_a t -> '_a t
  val concat: '_a t t -> '_a t
...
abstraction ImpSeq : IMP_SEQUENCE =
  struct
  datatype 'a t  = Nil
		 | Cons of 'a * ('a t) ref
		 | Delayed of unit -> 'a t;
...
signature VARRAY = 
  ...
  val reroot: 'a t -> 'a t
  val sub: 'a t * int -> 'a
  val justUpdate: '_a t * int * '_a -> '_a t
  val update: '_a t * int * '_a -> '_a t
  end;

(*Obsolete syntax, should be :> *)
abstraction Varray : VARRAY =
  struct
